...
class Measure:
    ...
    def angle(self, atom_data, atom_index1, atom_index2, atom_index3):
        self._checkEqual(atom_data.dataframe.loc[[atom_index1,atom_index2,atom_index3], ["x", "y", "z"]])

        vector1 = self._getVector(atom_data.dataframe.loc[[atom_index2,atom_index1], ["x", "y", "z"]], norm=True)
        vector2 = self._getVector(atom_data.dataframe.loc[[atom_index2,atom_index3], ["x", "y", "z"]], norm=True)
    ...
    def dihedral(self, atom_data, atom_index1, atom_index2, atom_index3, atom_index4):
        ...
        self._checkEqual(atom_data.dataframe.loc[[atom_index1,atom_index2,atom_index3,atom_index4], ["x", "y", "z"]])
        
        plane_normal1 = self.plane_normal(atom_data, atom_index1, atom_index2, atom_index3)
        plane_normal2 = self.plane_normal(atom_data, atom_index2, atom_index3, atom_index4)
